<template>
  <div class="card-wrap">
    <div class="card-form">
      <Form class="card-form" ref="form" :model="entity" :rules="rules" :label-width="120">
      <FormItem label="商户logo" prop="customer_logo">
        <Row class="logo-wrap">
          <i-col span="6">
            <img :src="entity.customer_logo" class="card-logo">
          </i-col>
          <i-col span="16">
      ...
      <FormItem label="商户名称" prop="customer_name" >
        <Row>
          <i-col span="15">
            <Input type="text" v-model="entity.customer_name" :maxlength="12"/>
          </i-col>
      ...
      <FormItem label="会员卡标题" prop="card_title">
        <Row>
          <i-col span="21">
            <Input type="text" v-model="entity.card_title" :maxlength="9"/>
          </i-col>
      ...
      <FormItem label="操作提示" prop="operation_hint">
        <Row>
          <i-col span="21">
            <Input type="text" v-model="entity.operation_hint" :maxlength="16" />
          </i-col>
          <i-col span="2" offset="1">
      ...
      <FormItem label="特权说明" prop="privilege">
        <Input type="textarea" v-model="entity.privilege" :autosize="{minRows: 2,maxRows: 5}" placeholder="特权"/>
      </FormItem>
      <FormItem label="使用须知" prop="use">
        <Input type="textarea" v-model="entity.use" :autosize="{minRows: 2,maxRows: 5}" placeholder="使用须知"/>
      </FormItem>
      <FormItem label="图文介绍">
      ...
      <FormItem label="客服电话" prop="customer_service_phone">
        <Row>
          <i-col span="13">
            <Input type="text" v-model="entity.customer_service_phone"/>
          </i-col>
      ...
      <FormItem label="必填信息" prop="required_information">
        <CheckboxGroup v-model="entity.required_information"  @on-change="relateOptional">
      ...
      <FormItem label="选填信息" prop="optional_information">
        <CheckboxGroup v-model="entity.optional_information">
...
export default {
  ...
  computed: {
    nameLength: function() {
      let nameLen = this.entity.customer_name.length
      return nameLen
    },
    titleLength: function() {
      let titleLen = this.entity.card_title.length
      return titleLen
    },
    hintLength: function() {
      let operationLen = this.entity.operation_hint.length
      return operationLen
    }
  },
  methods: {
