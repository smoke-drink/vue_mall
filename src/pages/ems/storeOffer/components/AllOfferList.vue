  ...
  <div>
      ...
      <div class="fr">
        <FormItem>
          ...
          <Button type="primary"
           ...
           <Button type="primary" @click="toCoupons">优惠券管理</Button> -->
        </FormItem>
      </div>
    </Form>
    ...
    <Modal v-model="editCommissionVisible" title="修改佣金">
      ...
      <div class="line">
        ...
        <span v-if="commissionType === 'one'">{{overAll.inPersent}}</span>
...
export default {
  ...
  methods: {
    ...
    move2Classify() {
      ...
      this.isShowMove2Classify = false
    },
    add2Classify() {
      let req = {
    ...
    editMoreOutPersent() {
      this.moreInPersent = 100 - this.moreOutPersent
    },
    editCommission() {
